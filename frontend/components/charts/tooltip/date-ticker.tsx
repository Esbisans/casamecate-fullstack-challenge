...
export function DateTicker({ currentIndex, labels, visible }: DateTickerProps) {
  ...
  return (
    <div className="overflow-hidden rounded-full bg-zinc-900 px-4 py-1.5 text-white shadow-lg dark:bg-zinc-100 dark:text-zinc-900">
